...
export const HeaderText = styled.div`
    ...
    padding: 0;
    margin: 0;
    text-shadow: 0px 0px 100px #00181e;
...
export const Line = styled.div`
    ...
    &::before {
        ...
        filter:  opacity(60%) invert(24%) sepia(0%)  brightness(100%) contrast(100%) hue-rotate(-56deg) saturate(400%) drop-shadow(4px 4px 6px rgba(37, 69, 69, 0.5));
    }
